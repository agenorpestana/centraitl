            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 text-slate-100 px-3 py-2 pr-10 rounded-xl outline-none focus:border-emerald-500"
                  required
                />
                <button
                  type="button"
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-400 flex flex-wrap items-center gap-2 mt-0.5">
                        ...
                        <span className="inline-flex items-center gap-1 text-[10px] text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded-md border border-amber-500/20 font-mono" title="Senha do Usuário">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-800 text-slate-100 p-2.5 pr-10 rounded-xl outline-none focus:border-emerald-500"
                      placeholder="Alterar senha (ex: 123456)"
                    />
                    <button
                      type="button"
